<?php 
	...
	if (isset($_POST['_action_']) && $_POST['_action_'] == 'add_news') {
		...
		$_SESSION['message'] .= '<p>Novost uspješno dodana!</p>';
	...
	if (isset($_POST['_action_']) && $_POST['_action_'] == 'edit_news') {
		...
		$_SESSION['message'] = '<p>Novost uspješno promjenjena!</p>';
	...
	if (isset($_GET['delete']) && $_GET['delete'] != '') {
		...
		$_SESSION['message'] = '<p>Novost je izbrisana!</p>';
	...
	#Add news 
		...
		<form action="" id="news_form" name="news_form" method="POST" enctype="multipart/form-data">
			...
			<textarea id="description" name="description" placeholder="Opis novosti" required></textarea>
	...
	#Edit news
		...
		<form action="" id="news_form_edit" name="news_form_edit" method="POST" enctype="multipart/form-data">
			...
			<label for="description">Opis*</label>
			<textarea id="description" name="description" placeholder="Opis novosti" required>' . $row['description'] . '</textarea>
